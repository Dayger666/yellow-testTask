        ...
        <div className='info'>
            <div className='container'>
                ...
                <div className='info__texts'>
                    <div className='info__text'>Lorem Ipsum is simply dummy text of the printing and typesetting
                    ...
                    <div className='info__text'>It is a long established fact that a reader will be distracted by the
